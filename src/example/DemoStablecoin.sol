...
contract DemoStablecoin is ERC20, ERC20Permit, AccessControl, DataDependent {
    address oracle;
    ...
    ) ERC20("DemoStablecoin Demo", "DEMOUSD") ERC20Permit("DEMOUSD") {
        oracle = _oracle;
    ...
    function mint(address to) public payable {
        ResponseWithExpenses memory response = _invokeOracle(oracle, priceProvider, ETH_USDT);
